---
id: examples-associations
title: Extending Entities/Associations
---

Using the field configuration properties, `as_type`, `join_on`, and `join_from`, you can extend or associate an entity with another.
